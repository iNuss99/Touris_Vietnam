...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Mật khẩu của bạn đã được cấp lại - Touris CRM</title>
</head>
<body style="margin:0;padding:0;background:#f0f4f8;font-family:'Segoe UI',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4f8;padding:40px 0;">
    <tr>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#0f766e,#0284c7);padding:36px 40px;text-align:center;">
              ...
              <p style="color:rgba(255,255,255,0.8);margin:8px 0 0;font-size:14px;">Tài khoản của bạn vừa được cấp lại mật khẩu tạm thời</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="color:#475569;font-size:14px;line-height:1.6;margin:0 0 28px;">
                Quản trị viên hệ thống đã thực hiện cấp lại mật khẩu cho tài khoản <strong>${to}</strong> của bạn.
              ...
              <div style="background:#fff7ed;border-left:4px solid #f97316;border-radius:8px;padding:14px 18px;margin-bottom:28px;">
                <p style="margin:0;color:#9a3412;font-size:13px;line-height:1.5;">
                  ⚠️ <strong>Lưu ý:</strong> Vui lòng sử dụng mật khẩu này để đăng nhập và tiến hành đổi mật khẩu cá nhân mới ngay khi đăng nhập.
                </p>
              </div>
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:20px 40px;text-align:center;">
              <p style="color:#94a3b8;font-size:12px;margin:0;">© ${new Date().getFullYear()} Touris Vietnam CRM · Thông báo bảo mật hệ thống</p>
            </td>
          </tr>
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Touris Vietnam CRM" <${process.env.GMAIL_USER}>`,
      to,
      subject: `🔑 Thông báo cấp lại mật khẩu Touris CRM — ${fullName}`,
      html,
    });
