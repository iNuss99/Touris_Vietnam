...
router.put('/:id/status', authMiddleware, requireRole('sales', 'super_admin'), checkLeadOwnership, leadsController.updateLeadStatus);
router.patch('/:id/status', authMiddleware, requireRole('sales', 'super_admin'), checkLeadOwnership, leadsController.updateLeadStatus);
